...
setup(
    ...
    ('share/' + package_name + '/models/r2d2models', ['models/r2d2models/r2d2.xacro.urdf']),
    ('share/' + package_name + '/config', ['config/diff_drive_controller.yaml']),
    ('share/' + package_name + '/r2d2_sim', ['r2d2_sim/robot_controller.py']),
    ],
    ...
    entry_points={
        'console_scripts': [ 
            'robot_controller = r2d2_sim.robot_controller:main',
        ],
    },
)
